...
import { AuthenticationStatus, NewUser, UserLogin } from './entities/Authentication';
...
export interface ApiAdapter {
   ...
   */
  requestUserPasswordReset(email: string, captchaToken: string, lng?: string): Promise<FetchResponse<undefined>>;
   ...
   * @param captchaToken the token generated by the captcha challenge
   */
  resetUserPassword(code: string, password: string, captchaToken: string): Promise<FetchResponse<undefined>>;
   ...
   */
  loginUser(data: UserLogin): Promise<AuthenticationStatus>;
   ...
   * @param lng the users preferred language
   */
  createUserAccount(data: NewUser, lng?: string): Promise<AuthenticationStatus>;
