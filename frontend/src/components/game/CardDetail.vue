  ...
  <div v-if="selectedCard" class="fixed z-50 inset-0" @click="closeDetail()">
    ...
    <div class="z-10 relative h-full w-full flex justify-center items-center flex-nowrap">
      <div class="absolute top-10 right-10">
        <button class="bg-bg hover:bg-bg flex flex-nowrap text-text text-2xl p-3 m-3 md:p-2 md:m-2 rounded" @click.stop="closeDetail">
      ...
      <div class="w-18 md:w-14 mr-4 md:mr-0">
        <button
          ...
          class="bg-bg hover:bg-bg flex flex-nowrap text-text text-2xl p-3 m-3 md:p-2 md:m-2 rounded"
      ...
      <div class="flex flex-col justify-center items-center flex-nowrap">
        ...
        <div class="card-to-play flex flex-col flex-nowrap justify-center items-center z-10">
          ...
          <button class="bg-bg hover:bg-bg px-4 py-2 my-2 rounded text-text border-2 border-transparent" @click.stop="handlePlayCard()">
