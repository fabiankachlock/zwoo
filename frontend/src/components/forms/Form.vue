<template>
  <button
    v-if="showBackButton"
    id="back-button"
    class="text-text-secondary bg-bg hover:bg-bg absolute left-2 top-2 text-xl p-1 rounded-md cursor-pointer"
    @click="goBack"
  >
  ...
  <button
    ...
    id="close-button"
    class="text-text-secondary bg-bg hover:bg-bg absolute right-2 top-2 text-xl p-1 rounded-md cursor-pointer"
    @click="emit('close')"
  >
