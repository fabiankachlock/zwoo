...
<template>
  <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-7xl">
    <svg class="text-primary-light dark:text-primary-dark" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
