<template>
  <FloatingDialog>
    <div class="flex flex-col mx-2 overflow-y-auto">
      <h2 class="text-text text-xl text-center mt-2">{{ t('cookies.title') }}</h2>
      <p class="text-text-secondary text-sm">{{ t('cookies.userInformation') }}</p>
      ...
      <div class="py-1">
        ...
        >
          <div class="min-h-0">
            <div class="item">
              <div>
                <h4 class="text text-text">{{ t('cookies.functional.auth.name') }}</h4>
