  ...
  <div v-if="!canShare" class="">
    <div>
      ...
      <a class="rsb__link" :href="`https://facebook.com/sharer/sharer.php?u=${url}`" target="_blank" rel="noopener" :aria-label="t('share.facebook')">
        <div class="rsb rsb--facebook rsb--large">
          <div aria-hidden="true" class="rsb__icon rsb__icon--solid">
      ...
      >
        <div class="rsb rsb--twitter rsb--large">
          <div aria-hidden="true" class="rsb__icon rsb__icon--solid">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
      ...
      <a
        class="rsb__link"
        :href="`https://reddit.com/submit/?url=${url}&resubmit=true&title=${encodeURIComponent(`${title}\n${text}`)}`"
        target="_blank"
        rel="noopener"
        :aria-label="t('share.reddit')"
      >
        <div class="rsb rsb--reddit rsb--large">
          <div aria-hidden="true" class="rsb__icon rsb__icon--solid">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
      ...
      <a
        class="rsb__link"
        :href="`whatsapp://send?text=${encodeURIComponent(`${title}\n${text}: ${url}`)}`"
        target="_blank"
        rel="noopener"
        :aria-label="t('share.whatsapp')"
      >
        <div class="rsb rsb--whatsapp rsb--large">
          <div aria-hidden="true" class="rsb__icon rsb__icon--solid">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
      ...
      <a
        class="rsb__link"
        :href="`https://telegram.me/share/url?text=${encodeURIComponent(`${title}\n${text}`)}&url=${url}`"
        target="_blank"
        rel="noopener"
        :aria-label="t('share.telegram')"
      >
        <div class="rsb rsb--telegram rsb--large">
          <div aria-hidden="true" class="rsb__icon rsb__icon--solid">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path
